            ...
            linkReceived: (url: string) =>
            {
                ...
                switch(parts[1])
                {
                    ...
                    case 'goto':
                        ...
                        return;
                    case 'create':
                        if(!GetSessionDataManager().hasSecurity(7)) return;
                        setIsVisible(true);
                        setCreatorOpen(true);
                        return;
                    case 'search':
            ...
            { isVisible &&
                <NitroCardView uniqueKey="navigator" className="nitro-navigator">
                    ...
                    <NitroCardTabsView>
                        ...
                        { GetSessionDataManager().hasSecurity(7) &&
                    ...
                    <NitroCardContentView position="relative">
                        ...
                        { isCreatorOpen && GetSessionDataManager().hasSecurity(7) && <NavigatorRoomCreatorView /> }
